...
angular.module('blogApp')
  .controller('CodeCtrl', function ($scope, $timeout, $mdSidenav, $mdUtil, $log, DataService, DataPrepService, ColumnSize, $mdMedia) {
        ...
        $scope.$watch(function() { return $mdMedia('(min-width: 1400px) and (max-width: 2100px'); }, function(isLargest) {
        ...
        $scope.$watch(function() { return $mdMedia('(min-width: 1100px) and (max-width: 1400px)'); }, function(isLarge) {
